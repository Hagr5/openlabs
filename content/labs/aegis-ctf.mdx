---
title: Aegis ctf
description: Chained API trust vulnerabilities across REST, GraphQL, and gRPC.
track: web
difficulty: hard
port: "3000"
type: lab
...
keywords:
  primary: Aegis ctf web security lab docker
  secondary:
    - hard web practice
    - openlabs aegis-ctf
verified: true
score: 79
score_grade: C
author_name: "YousefElSayed19"
author_url: "https://github.com/YousefElSayed19"
author_avatar: "https://github.com/YousefElSayed19.png"
author_date: "2026-09-09"
ogImage: /og/labs-aegis-ctf.png
---

{/* Generated from labs/web/aegis-ctf/lab.yml and README.md. Do not edit by hand. Run scripts/sync_site_content.py. */}
