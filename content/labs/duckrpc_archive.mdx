---
title: Duckrpc_archive
description: A gRPC document archive with authentication and a SQL injection vulnerability.
track: web
difficulty: medium
port: "50051"
type: lab
key: lab-duckrpc_archive
slug: labs/duckrpc_archive
intent: Solve a medium web lab in Docker.
keywords:
  primary: Duckrpc_archive web security lab docker
  secondary:
    - medium web practice
    - openlabs duckrpc_archive
verified: false
score: 33
score_grade: F
author_name: "unknown"
...
ogImage: /og/labs-duckrpc_archive.png
---

{/* Generated from labs/web/duckrpc_archive/lab.yml and README.md. Do not edit by hand. Run scripts/sync_site_content.py. */}
