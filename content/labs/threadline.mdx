---
title: Threadline
description: A clothing store REST API. One customer sees more than they should.
track: web
difficulty: medium
port: "1000"
type: lab
key: lab-threadline
slug: labs/threadline
intent: Solve a medium web lab in Docker.
keywords:
  primary: Threadline web security lab docker
  secondary:
    - medium web practice
    - openlabs threadline
verified: true
...
score_grade: C
author_name: "Hagr5"
author_url: "https://github.com/duckurity/openlabs/commits/main/labs/web/threadline"
author_date: "2026-09-10"
ogImage: /og/labs-threadline.png
---

{/* Generated from labs/web/threadline/lab.yml and README.md. Do not edit by hand. Run scripts/sync_site_content.py. */}
