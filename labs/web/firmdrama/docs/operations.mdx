...
synchronizes metadata. The separate host-side [checker](../scripts/check.py)
...
hash pairs, write failures, Docker failures, one-time synchronization, checker stages,
and checker metadata failures:
